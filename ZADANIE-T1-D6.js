...
*/
odpowiedź("A");
uzasadnienie(`klasyfikowanie jest potrzebne zeby wiedziec jakie operacje mozna wykonac na zminnej.`);
...
*/
odpowiedź("undefined");
uzasadnienie(`W sumie to zgaduje`);
...
*/
odpowiedź("B");
uzasadnienie(`No pętla tez na szyje moze byc?`);
...
*/
odpowiedź("1010");
uzasadnienie(`typdanych do lewej wiec caly jest string`);
...
*/
odpowiedź("4");
uzasadnienie(`kurwa jebie mi sie wszystko jak wpisujesz pojedyncze literki do klucza bo mam wrazenie ze to zmienna, wiem ze zeby uzyc zmiennej jako klucza daje sie w [], b jest stala "nie da sie"`);
...
uzasadnienie(`w nawiasie podaje parametry po przecinku`);
...
uzasadnienie(`pierw obiekt poxniej klucz`);
...
uzasadnienie(`tablice zaczynaja liczyc od 0 wiec 9`);
...
*/
odpowiedź("infinity");
uzasadnienie(`zero razy co kolwiek to dalej zero wiec sie nie inkrementuje wiec jest infinity loop`);
