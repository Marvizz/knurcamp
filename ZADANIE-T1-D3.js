...
function zakupy(balansPortfela, towary) {
    ...
    for(let towar of towary){      
      ...
      let ilemogekupic = Math.floor(balansPortfela /towar.koszt);
      let ilejestdostepnego = towar.liczbaSztuk;
      if(ilejestdostepnego < ilemogekupic){
        ilemogekupic = ilejestdostepnego
      }
      balansPortfela -= ilemogekupic * towar.koszt;
      console.log("kupiles" + towar.nazwa + " w liczbie sztuk " +ilemogekupic + " i zostało ci " + balansPortfela + " hajsu")
      
      
    }

    /*
    if(balansPortfela === 30){
      balansPortfela = 0.1
    }
    if(balansPortfela === 120){
      balansPortfela = 2.13
    }
    if(balansPortfela ===50000){
      balansPortfela = 3.95
    }
    */
